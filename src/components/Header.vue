    ...
    <nav class="flex items-center justify-between p-6 md:px-8 bg-zinc-900/50 backdrop-blur-md" aria-label="Global">
      <div class="flex md:flex-1">
        <RouterLink to="/" class="-m-1.5 p-1.5">
          <span class="sr-only">RISD Concept Art Club</span>
      ...
      <div class="hidden md:flex md:flex-1 md:justify-end">
        ...
        <template v-else>
          <RouterLink to="/login" class="text-sm/6 font-semibold text-white">Log in <span
            ...
            <div class="py-6">
              ...
              <template v-if="store.isAuthenticated">
                <div>
                  ...
                  <RouterLink to="/me"
                    class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white/50">Hi {{
